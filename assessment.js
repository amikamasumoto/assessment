...
const resurltDivision = document.getElementById('result-area');
...
assessmentButton.addEventListener(
  ...
  () => {
    ...
    // 診断結果表示エリアの作成
    resurltDivision.innerText = '';
    const heading = document.createElement('h3');
    heading.innerText = '診断結果';
    resurltDivision.appendChild(heading);

    const paragraph = document.createElement('p');
    const result = assessment(userName);
    paragraph.innerText = result;
    resurltDivision.appendChild(paragraph);
    // TODO ツイートエリアの作成
    tweetDivision.innerTexxt = '';
